...
class CartController extends Controller
{
    ...
    public function showCartModal(Request $request)
    {
        ...
        $type = $request->type;
        return view('frontend.partials.addToCart', compact('product', 'type'));
    }
    ...
    public function updateQuantity(Request $request)
    {
        ...
        if($cartItem['id'] == $request->id){
            ...
            if($quantity < $request->quantity) {
                return array(
                    'status' => 0,
                    'message' => translate('Stock not available'),
                );
            }
            ...
            if($request->quantity < $product->min_qty){
                return array(
                    'status' => 0,
                    'message' => translate('Minimum quantity is') . ' ' . $product->min_qty,
                );
            }
        ...
        $item_total = ($cartItem['price'] + $cartItem['tax']) * $cartItem['quantity'];

        return array(
            'status' => 1,
            'cart_count' => count($carts),
            'cart_total' => single_price($total),
            'item_total' => single_price($item_total),
