...
class CityController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->sort_state) {
            $cities_queries->where('district_id', $request->sort_state);
        }
    ...
    public function store(Request $request)
    {
        ...
        $city->district_id = $request->state_id;

        $city->save();

        flash(translate('Array has been inserted successfully'))->success();
    ...
    public function update(Request $request, $id)
    {
        ...
        flash(translate('Array has been updated successfully'))->success();
        return back();
    }
    ...
    public function destroy($id)
    {
        ...
        flash(translate('Array has been deleted successfully'))->success();
