...
class ProductController extends Controller
{
    ...
    public function admin_products(Request $request)
    {
        ...
        $products = $products->where('digital', 0)->orderBy('created_at', 'desc')->paginate(20);
    ...
    public function all_products(Request $request)
    {
        ...
        if ($request->section_type == 'featured') {
            $products = $products->where('featured', 1);
            $section_type = $request->section_type;
        }

        if ($request->section_type == 'new_product') {
            $products = $products->where('new_product', 1);
            $section_type = $request->section_type;
        }

        if ($request->section_type == 'best_selling') {
            $products = $products->where('best_selling', 1);
            $section_type = $request->section_type;
        }

        if ($request->section_type == 'category_by_featured') {
            $products = $products->where('category_by_featured', 1);
            $section_type = $request->section_type;
        }
        ...
        return view('backend.product.products.index', compact('products', 'type', 'col_name', 'section_type', 'query', 'seller_id', 'sort_search', 'categories', 'category_id'));
    }
    ...
    public function updateFeatured(Request $request)
    {
        ...
        if($request->type == 'featured'){
            ...
            $product->new_product = $request->status;
        }elseif($request->type == 'best_selling'){
            $product->best_selling = $request->status;
        }elseif($request->type == 'category_by_featured'){
            $product->category_by_featured = $request->status;
        }
