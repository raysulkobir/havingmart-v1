...
class CategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $categories = $categories->paginate(200);
        return view('backend.product.categories.index', compact('categories', 'sort_search', 'catCount'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if(isset($request->slug)){
            ...
            if ($slug) {
                $category->slug = $request->slug . '-' . strtolower(Str::random(5));
            } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        $slug = Category::where('slug', $request->slug)->whereNotIn('id', [$id])->first();
    ...
    public function shopByConcern(Request $request)
    {
        $category = Category::findOrFail($request->id);
        $category->shop_by_concern = $request->shop_by_concern;
        $category->save();
        Cache::forget('featured_categories');
        return 1;
    }
