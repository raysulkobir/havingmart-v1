                        ...
                        <div class="shadow-sm bg-white p-3 p-lg-4 rounded text-left">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 text-center text-md-right">
                                    @if (Auth::check())
                                        <a href="{{ route('checkout.express.show') }}" class="btn btn-primary fw-600">
                                            <i class="las la-bolt mr-2"></i>
                                            {{ translate('Checkout') }}
                                        </a>
                                    @else
                                        <a href="{{ route('checkout.express.show') }}" class="btn btn-primary fw-600">
        ...
        <div class="modal-dialog modal-dialog-zoom">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <form class="form-default" role="form" action="{{ route('cart.login.submit') }}" method="POST" id="login-form">
                            @csrf
                            <input type="hidden" name="checkout_type" id="checkout_type" value="">
...
@section('script')
    <script type="text/javascript">
        ...
        function showCheckoutModal(checkoutType = 'traditional') {
            $('#checkout_type').val(checkoutType);
            $('#login-modal').modal();
        }
