                        ...
                        <div class="text-left">
                            ...
                            <div class="row align-items-center">
                                <div class="col-12">
                                    ...
                                    <span class="ml-3 opacity-50">
                                        ...
                                        {{ number_format((int) $detailedProduct->product_view_count) }}
                                        {{ translate('views') }}
                                    </span>
                                </div>
                            ...
                            {{-- <div class="row align-items-center">
                                ...
                                @if (get_setting('conversation_system') == 1)
                                    <div class="col-auto">
                                        <button class="btn btn-sm btn-soft-primary 2"
                            ...
                            @else
                                @if (home_price($detailedProduct) != home_discounted_price($detailedProduct))
                                    <div class="row no-gutters mt-3">
                                        <div class="col-sm-2">
                                            <div class="opacity-50 my-2">{{ translate('Regular Price') }}:</div>
                                        </div>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row no-gutters my-3">
                                        <div class="col-sm-2">
                                            <div class="opacity-50 my-1">{{ translate('Discount Price:') }}:</div>
                                        </div>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row no-gutters mt-3">
                                        <div class="col-sm-2">
                                            <div class="opacity-50 my-2">{{ translate('Unit/Wight') }}:</div>
                                        </div>
                                        <div class="col-sm-10">
                                            <div class="fs-20 opacity-60">
                                                <div>
                                                    {{ $detailedProduct->weight ? (float)$detailedProduct->weight : ''}}
                                    ...
                                    <div class="row no-gutters mt-3">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="">
                                                ...
                                                @if ($detailedProduct->unit != null)
                                                    <span
                                                        class="opacity-50 fs-15">/{{ $detailedProduct->getTranslation('unit') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <form id="option-choice-form">
                                                ...
                                                @foreach (json_decode($detailedProduct->colors) as $key => $color)
                                                    <label class="aiz-megabox pl-0 mr-2" data-toggle="tooltip"
                                                        ...
                                                        <input type="radio" name="color"
                                                            ...
                                                            @if ($key == 0) checked @endif>
                                                        <span
                                                            class="aiz-megabox-elem d-flex align-items-center justify-content-center p-1" id="border_radius_50" >
                                                            <span class="border_radius_50 size-20px d-inline-block"
                                ...
                                <div class="row no-gutters pb-3 d-none" id="chosen_price_div">
                                    <div class="col-sm-2">
                                        <div class="opacity-60 my-1 fw-700">{{ translate('Total Price') }}:</div>
                                    </div>
                                    <div class="col-sm-10">
                                        <div class="product-price">
                                            <strong id="chosen_price" class="h4 fw-700 text-primary">
                    ...
                    @if ($detailedProduct->added_by == 'seller' && $detailedProduct->user->shop != null)
                        <div class="bg-white shadow-sm mb-3">
                            <div class="position-relative p-3 text-left">
                                ...
                                <div class="col pt-3">
                                    <a href="{{ route('shop.visit', $detailedProduct->user->shop->slug) }}"
                                        class="d-block btn btn-soft-primary btn-sm p-2">{{ translate('Visit Store') }}</a>
                                </div>
                            </div>
                        </div>
                    @endif
