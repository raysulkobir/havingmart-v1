        ...
        <div class="col-lg-6">
            <div class="text-left">
                ...
                @if(home_price($product) != home_discounted_price($product))
                    <div class="row align-items-center no-gutters mt-1">
                        <div class="col-md-4 col-5">
                            <div class="opacity-50">{{ translate('Regular Price')}}:</div>
                        </div>
                    ...
                    <div class="row align-items-center no-gutters mt-3">
                        <div class="col-md-4 col-5">
                            <div class="opacity-50">{{ translate('Size') }}:</div>
                        </div>
                        <div class="col-md-8 col-7">
                            <div class="fs-20 opacity-60">
                                <div>
                                    ...
                                    @if ($product->unit != null)
                                        <span class="opacity-70 fs-14">{{ $product->getTranslation('unit') }}</span>
                                    @endif
                                </div>
                            </div>
                        </div>
                ...
                <form id="option-choice-form">
                        ...
                        @if ($product->choice_options != null)
                            @foreach (json_decode($product->choice_options) as $key => $choice)
                                ...
                                <div class="row align-items-center no-gutters">
                                    <div class="col-md-4 col-5">
                                        <div class="opacity-50">{{ \App\Models\Attribute::find($choice->attribute_id)->getTranslation('name') }}:</div>
                                    </div>
                                    <div class="col-md-8 col-7">
                        ...
                        <div class="row align-items-center no-gutters">
                            ...
                            <div class="col-md-8 col-7">
                                <div class="product-quantity d-flex align-items-center">
                                    <div class="row no-gutters align-items-center aiz-plus-minus mr-3" style="width: 115px;">
                    ...
                    <div class="row align-items-center no-gutters pb-1 d-none" id="chosen_price_div">
                        <div class="col-md-4 col-5">
                ...
                <div class="mt-3 text-center">
                    @if ($product->digital == 1)
                        <button type="button" class="btn btn-primary  buy-now fw-600 add-to-cart" onclick="addToCart()">
                            ...
                            <span class="d-inline-block">{{ translate('অর্ডার সম্পন্ন করি')}}</span>
                        </button>
                    @elseif($qty > 0)
                        @if ($product->external_link != null)
                            <a type="button" class="btn btn-soft-primary text-white mr-2 add-to-cart fw-600" href="{{ $product->external_link }}">
                                <i class="las la-share"></i>
                                <span class="d-none d-md-inline-block">{{ translate($product->external_link_btn)}}</span>
                            </a>
                        @else
                            @if($type)
                                <button type="button" class="btn btn-primary text-white  buy-now fw-600 add-to-cart" onclick="addToCart(true)">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-2" style="vertical-align: middle;"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg>
                                    <span class="d-inline-block">{{ translate('অর্ডার সম্পন্ন করি')}}</span>
                                </button>
                            @else
                                <button type="button" class="btn btn-primary text-white buy-now fw-600 add-to-cart" onclick="addToCart()">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-2" style="vertical-align: middle;"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg>
                                    <span class="d-inline-block">{{ translate('অর্ডার সম্পন্ন করি')}}</span>
                                </button>
                            @endif
