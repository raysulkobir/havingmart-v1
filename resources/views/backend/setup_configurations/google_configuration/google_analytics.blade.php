                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('google_tag_manager.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="google_tag_manager" type="checkbox" @if (get_setting('google_tag_manager') == 1)
                                        checked
                                    @endif>
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="GTM_ID">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('GTM ID')}}</label>
                            </div>
                            <div class="col-md-7">
                                <input type="text" class="form-control" name="GTM_ID" value="{{  env('GTM_ID') }}" placeholder="{{ translate('GTM ID') }}" required>
                            </div>
                        </div>
                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
