...
Route::get('ddd', function(){
    Artisan::call('cache:clear');       // Application cache clear
    Artisan::call('config:clear');      // Config cache clear
    Artisan::call('route:clear');       // Route cache clear
    Artisan::call('view:clear');        // Compiled view cache clear
    Artisan::call('optimize:clear');    // Optimization cache clear (includes events, compiled files)
...
Route::controller(ScrapingController::class)->group(function () {
    Route::get('/scr-category', 'category');
    Route::get('/scr-all', 'all');
...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::post('/users/otp-send', 'otp_send')->name('user.otp_send');
    Route::get('/users/otp-verify', 'otp_verify')->name('user.otp_verify');
    Route::post('/users/user-otp-verify', 'user_otp_verify')->name('user.user_otp_verify');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function() {
    ...
    Route::controller(WishlistController::class)->group(function () {
        Route::get('/wishlist', 'index')->name('wishlists.index');
        Route::post('/wishlist/store', 'store')->name('wishlists.store');
        Route::post('/wishlist/remove', 'remove')->name('wishlists.remove');
    });
...
// Express Checkout - Allow guest access
Route::group(['prefix' => 'checkout'], function() {
    Route::controller(CheckoutController::class)->group(function () {
        Route::get('/express', 'show_express_checkout')->name('checkout.express.show');
        Route::post('/express', 'express_checkout')->name('checkout.express');
